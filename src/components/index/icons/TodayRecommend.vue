        ...
        <ul class="goodsCon">
            <li v-for="k in bottomGoodsList">
                <router-link :to="`/taoDetail?NUM_IID=${k.goodsId}`">
                    ...
                    <div class="container">
                      <div class="top">
                        <img :src=" k.goodsType == 0 ? require('../../../assets/img/category/tb.png') : require('../../../assets/img/category/tm.png')"/>
                        <p>{{k.goodsName}}</p>
                      </div>
                      <div class="bottom">
        ...
        getContent: function () {
            api.get("/fox/app/home/todayRecommendGoods",{
              ...
              (response)=>{
                ...
                console.log(response.data.content.todayRecommendBottomGoods)
              },
              (error)=>{
                  Toast("加载失败。。。");
              }
